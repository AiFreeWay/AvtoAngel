...
public class MockStore {
    ...
    public MockStore() {
        ...
        mCars.add(new Car(0, "Тесла", Car.STATE_LOCK, Car.NOTIFICATION_ON, "+7(123) 4344 54 45"));
        mCars.add(new Car(1, "Москвич", Car.STATE_LOCK, Car.NOTIFICATION_OFF, "+7(123) 4344 54 45"));
        mCars.add(new Car(2, "Мазда", Car.STATE_UNLOCK, Car.NOTIFICATION_ON, "+7(123) 4344 54 45"));
    }
