...
public class AppMenuFactory {
    ...
    private void generateItems() {
        ...
        mMenu.add(MenuItems.SHOP.id, new AppMenuItem("Купить трекер", R.drawable.ic_shop, new FragmentHandleMemento(FragmentsFactory.Fragments.SHOP, AbstractHundleMemento.MenuHandlers.FRAGMENT)));
        ...
        mMenu.add(MenuItems.EXIT.id, new AppMenuItem("Выйти", R.drawable.ic_exit, new ActionHundleMemento(null, AbstractHundleMemento.MenuHandlers.ACTION)));
    }
